...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-[#151515] text-white py-10 md:py-20 mt-10 md:mt-12 lg:mt-16">
            <div className="space-y-2">
                <img src={logo} alt="" />
                <p>Cars Doctors Ltd.<br />Providing reliable services since 2023</p>
