            ...
            <div>
                ...
                <div className='flex flex-col lg:flex-row gap-10 my-10 lg:mt-20'>
                    ...
                    <div className='w-full lg:w-1/2'>
                        ...
                        <div className='bg-black lg:w-2/3 p-4 text-white rounded-lg my-7 text-center items-center relative h-80'>
                            <div>
                                <img src={logo} alt="" className=' mx-auto' />
                                <h1 className='my-3 font-medium'>Need Help? We Are Here <br />
                                    To Help You</h1>

                                <div className='bg-white p-3 w-3/4 mx-auto rounded-lg h-24'>
                               ...
                               <div className='absolute bottom-3 right-1/3 lg:right-[30%] pb-4'>
                               <button className='mySecBtn'>Get A Quote</button>
                               </div>
                            </div>
                        </div>
                        <div>
                            <h1 className='text-2xl font-extrabold'>Price ${price}</h1>
                            <Link to={`/checkout/${_id}`}>
                                <button className='mySecBtn lg:w-2/3 mt-6'>
                                Proceed Checkout
                                </button>
                            </Link>
                        </div>
